<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="orden.aspx.cs" Inherits="WebConsumo.Vista.orden" %>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control input-sm no-null" id="txtFecha">
                                </div>
                            </div>
                        </div>
